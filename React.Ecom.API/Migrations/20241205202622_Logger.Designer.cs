...
namespace React.Ecom.API.Migrations
{
    ...
    [Migration("20241205202622_Logger")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("React.Ecom.API.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("React.Ecom.API.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("React.Ecom.API.Models.ErrorLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("React.Ecom.API.Models.MenuItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("React.Ecom.API.Models.OrderDetails", b =>
                {
            ...
            modelBuilder.Entity("React.Ecom.API.Models.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("React.Ecom.API.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("React.Ecom.API.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("React.Ecom.API.Models.CartItem", b =>
                {
                    b.HasOne("React.Ecom.API.Models.MenuItem", "MenuItem")
                        .WithMany()
                        .HasForeignKey("MenuItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("React.Ecom.API.Models.ShoppingCart", null)
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("React.Ecom.API.Models.OrderDetails", b =>
                {
                    ...
                    b.HasOne("React.Ecom.API.Models.OrderHeader", null)
            ...
            modelBuilder.Entity("React.Ecom.API.Models.OrderHeader", b =>
                {
                    b.HasOne("React.Ecom.API.Models.ApplicationUser", "User")
                        .WithMany()
